...
async function migrate() {
  ...
  await pool.query(`
    ...
    ALTER TABLE bank_transactions ADD COLUMN IF NOT EXISTS client_id      INTEGER;
    ALTER TABLE bank_transactions ADD COLUMN IF NOT EXISTS client_ids     integer[] DEFAULT '{}';
    ALTER TABLE bank_transactions ADD COLUMN IF NOT EXISTS invoice_ref    TEXT;
